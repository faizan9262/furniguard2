  ...
  return (
    <div className="min-h-screen flex justify-center gap-5 flex-col items-center shadow-lg rounded-lg">
      ...
      <button
        ...
        className="flex items-center gap-2 bg-primary text-white rounded-full px-5    py-2 text-xl font-medium shadow-md hover:scale-105 transition-all duration-300 hover:bg-secondary"
      >
